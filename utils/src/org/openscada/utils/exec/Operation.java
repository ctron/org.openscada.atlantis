 ...
 * If you wish to:
 * <ul>
 *  <li>Implement an operation that is synchronous you need to derive from
 *      {@link SyncBasedOperation}</li>
 *  <li>Implement an operation that s asynchronous you need to derive from
 *      {@link AsyncBasedOperation}</li>
 *  <li>Call an operation synchronously see {@link #execute}</li>
 *  <li>Call an operation asynchronously see {@link #startExecute(Object)}</li>
 *  <li>Call an operation an get notified by callback {@link #startExecute(OperationResultHandler handler, Object arg0)}</li> 
 * </ul>
 * @author jens
 *
