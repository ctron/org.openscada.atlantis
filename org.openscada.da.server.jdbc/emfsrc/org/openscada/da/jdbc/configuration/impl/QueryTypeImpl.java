 ...
 * <ul>
 *   <li>{@link org.openscada.da.jdbc.configuration.impl.QueryTypeImpl#getSql <em>Sql</em>}</li>
 *   <li>{@link org.openscada.da.jdbc.configuration.impl.QueryTypeImpl#getColumnMapping <em>Column Mapping</em>}</li>
 *   <li>{@link org.openscada.da.jdbc.configuration.impl.QueryTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.openscada.da.jdbc.configuration.impl.QueryTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.openscada.da.jdbc.configuration.impl.QueryTypeImpl#getSql1 <em>Sql1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QueryTypeImpl extends MinimalEObjectImpl.Container implements QueryType
{
    ...
    public void setSql ( String newSql )
    {
        ...
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, ConfigurationPackage.QUERY_TYPE__SQL, oldSql, sql ) );
    }
    ...
    public EList<ColumnMappingType> getColumnMapping ()
    {
        ...
        {
            columnMapping = new EObjectContainmentEList<ColumnMappingType> ( ColumnMappingType.class, this, ConfigurationPackage.QUERY_TYPE__COLUMN_MAPPING );
        }
    ...
    public void setId ( String newId )
    {
        ...
        id = newId;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, ConfigurationPackage.QUERY_TYPE__ID, oldId, id ) );
    }
    ...
    public void setPeriod ( int newPeriod )
    {
        ...
        periodESet = true;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, ConfigurationPackage.QUERY_TYPE__PERIOD, oldPeriod, period, !oldPeriodESet ) );
    }
    ...
    public void unsetPeriod ()
    {
        ...
        periodESet = false;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.UNSET, ConfigurationPackage.QUERY_TYPE__PERIOD, oldPeriod, PERIOD_EDEFAULT, oldPeriodESet ) );
    }
    ...
    public void setSql1 ( String newSql1 )
    {
        ...
        sql1 = newSql1;
        if ( eNotificationRequired () )
            eNotify ( new ENotificationImpl ( this, Notification.SET, ConfigurationPackage.QUERY_TYPE__SQL1, oldSql1, sql1 ) );
    }
    ...
    public NotificationChain eInverseRemove ( InternalEObject otherEnd, int featureID, NotificationChain msgs )
    {
        switch ( featureID )
        {
            case ConfigurationPackage.QUERY_TYPE__COLUMN_MAPPING:
    ...
    public Object eGet ( int featureID, boolean resolve, boolean coreType )
    {
        switch ( featureID )
        {
            case ConfigurationPackage.QUERY_TYPE__SQL:
                return getSql ();
            case ConfigurationPackage.QUERY_TYPE__COLUMN_MAPPING:
                return getColumnMapping ();
            case ConfigurationPackage.QUERY_TYPE__ID:
                return getId ();
            case ConfigurationPackage.QUERY_TYPE__PERIOD:
                return getPeriod ();
            case ConfigurationPackage.QUERY_TYPE__SQL1:
                return getSql1 ();
        }
