...
{
    private static final String SPECIFIC_PREFIX = "org.openscada.ae.slave.pull";

    private final static Logger logger = LoggerFactory.getLogger ( PullManager.class );

    public static final String FACTORY_ID = "org.openscada.ae.slave.pull";
    ...
    {
        return System.getProperty ( "org.openscada.ae.slave.pull.local.schema", "" );
    }
