...
public class ConfigurationActionBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			SnmpEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				SnmpEditorPlugin.INSTANCE
						.getString("_UI_ConfigurationEditor_menu"), "org.openscada.da.snmp.configurationMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
