...
public class ContainerCreator
{
    ...
    public static ContainerFactory findFactory ( final Class<?> clazz ) throws ConfigurationError
    {
    ...
    private static ContainerFactory instantiateFactory ( final Class<?> factoryClass ) throws ConfigurationError
    {
        Object o;
        try
        {
