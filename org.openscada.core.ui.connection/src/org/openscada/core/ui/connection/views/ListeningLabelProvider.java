...
public class ListeningLabelProvider extends ViewerLabelProvider
{
    ...
    private final ConnectionObservableFactory factory;
     ...
     */
    public ListeningLabelProvider ( final IObservableSet itemsThatNeedLabels, final ConnectionObservableFactory factory )
    {
