 ...
 * <ul>
 *   <li>{@link org.openscada.da.snmp.configuration.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.openscada.da.snmp.configuration.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.openscada.da.snmp.configuration.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.openscada.da.snmp.configuration.impl.DocumentRootImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this,
					ConfigurationPackage.DOCUMENT_ROOT__MIXED);
		}
		return mixed;
	}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String, String>(
					EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
					EStringToStringMapEntryImpl.class, this,
					ConfigurationPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	...
	public ConfigurationType getConfiguration() {
		return (ConfigurationType) getMixed().get(
				ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION,
				true);
	}
	...
	public NotificationChain basicSetConfiguration(
			ConfigurationType newConfiguration, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION,
				newConfiguration, msgs);
	}
