 ...
 * @generated
 */
public class MibsTypeImpl extends MinimalEObjectImpl.Container implements
		MibsType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this,
					ConfigurationPackage.MIBS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<String> getMibDir() {
		return getGroup()
				.list(ConfigurationPackage.Literals.MIBS_TYPE__MIB_DIR);
	}
