...
public class ConfigurationPackageImpl extends EPackageImpl implements
	...
	public static ConfigurationPackage init() {
		...
		EValidator.Registry.INSTANCE.put(theConfigurationPackage,
	...
	public EReference getConfigurationType_Mibs() {
		return (EReference) configurationTypeEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getConnectionType_Address() {
		return (EAttribute) connectionTypeEClass.getEStructuralFeatures()
				.get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConnectionType_LimitToOid() {
		return (EAttribute) connectionTypeEClass.getEStructuralFeatures()
				.get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConnectionType_Retries() {
		return (EAttribute) connectionTypeEClass.getEStructuralFeatures()
				.get(5);
	}
	...
	public void createPackageContents() {
		...
		createEReference(configurationTypeEClass,
				CONFIGURATION_TYPE__CONNECTION);
		...
		createEAttribute(connectionTypeEClass, CONNECTION_TYPE__LIMIT_TO_OID);
		createEAttribute(connectionTypeEClass, CONNECTION_TYPE__RETRIES);
	...
	public void initializePackageContents() {
		...
		initEClass(
				...
				"ConfigurationType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEReference(
				getConfigurationType_Mibs(),
				this.getMibsType(),
				null,
				"mibs", null, 1, 1, ConfigurationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(
				getConfigurationType_Connection(),
				this.getConnectionType(),
				null,
				"connection", null, 0, -1, ConfigurationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				connectionTypeEClass,
				ConnectionType.class,
				"ConnectionType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getConnectionType_Address(),
				this.getAddress(),
				"address", null, 1, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getConnectionType_Community(),
				theXMLTypePackage.getNMTOKEN(),
				"community", null, 1, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getConnectionType_Name(),
				theXMLTypePackage.getNMTOKEN(),
				"name", null, 1, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getConnectionType_Version(),
				this.getSnmpVersion(),
				"version", "2", 0, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(
				getConnectionType_LimitToOid(),
				ecorePackage.getEString(),
				"limitToOid", null, 0, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getConnectionType_Retries(),
				ecorePackage.getEInt(),
				"retries", "1", 0, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(
				getConnectionType_Timeout(),
				ecorePackage.getELong(),
				"timeout", "5000", 0, 1, ConnectionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEReference(
				...
				null,
				"configuration", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				mibsTypeEClass,
				MibsType.class,
				"MibsType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getMibsType_Group(),
				ecorePackage.getEFeatureMapEntry(),
				"group", null, 0, -1, MibsType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getMibsType_StaticMibName(),
				theXMLTypePackage.getString(),
				"staticMibName", null, 0, -1, MibsType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getMibsType_MibDir(),
				theXMLTypePackage.getString(),
				"mibDir", null, 0, -1, MibsType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getMibsType_RecursiveMibDir(),
				theXMLTypePackage.getString(),
				"recursiveMibDir", null, 0, -1, MibsType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEDataType(addressEDataType, String.class,
				"Address", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEDataType(
				snmpVersionObjectEDataType,
				SnmpVersion.class,
				"SnmpVersionObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(addressEDataType, source, new String[] {
		...
		addAnnotation(getConfigurationType_Mibs(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "mibs", //$NON-NLS-1$ //$NON-NLS-2$
				"namespace", "##targetNamespace" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getConfigurationType_Connection(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "connection", //$NON-NLS-1$ //$NON-NLS-2$
				"namespace", "##targetNamespace" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(connectionTypeEClass, source, new String[] {
				"name", "connectionType", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "empty" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getConnectionType_Address(), source, new String[] {
				"kind", "attribute", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "address" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getConnectionType_Community(), source, new String[] {
				"kind", "attribute", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "community" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getConnectionType_Name(), source, new String[] {
				"kind", "attribute", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "name" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getConnectionType_Version(), source, new String[] {
				"kind", "attribute", //$NON-NLS-1$ //$NON-NLS-2$
		...
		addAnnotation(mibsTypeEClass, source, new String[] {
				"name", "mibsType", //$NON-NLS-1$ //$NON-NLS-2$
				"kind", "elementOnly" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getMibsType_Group(), source, new String[] {
				"kind", "group", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "group:0" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getMibsType_StaticMibName(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "staticMibName", //$NON-NLS-1$ //$NON-NLS-2$
				"namespace", "##targetNamespace", //$NON-NLS-1$ //$NON-NLS-2$
				"group", "#group:0" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getMibsType_MibDir(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "mibDir", //$NON-NLS-1$ //$NON-NLS-2$
				"namespace", "##targetNamespace", //$NON-NLS-1$ //$NON-NLS-2$
				"group", "#group:0" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(getMibsType_RecursiveMibDir(), source, new String[] {
				"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
				"name", "recursiveMibDir", //$NON-NLS-1$ //$NON-NLS-2$
				"namespace", "##targetNamespace", //$NON-NLS-1$ //$NON-NLS-2$
				"group", "#group:0" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(snmpVersionEEnum, source, new String[] {
				"name", "snmpVersion" //$NON-NLS-1$ //$NON-NLS-2$
		});
		addAnnotation(snmpVersionObjectEDataType, source, new String[] {
