...
{
    public DoubleIntegerVariable ( final String name, final int index, final Executor executor, final ObjectPoolImpl itemPool, final Attribute... attributes )
    {
    ...
    protected NotifyFuture<WriteResult> handleWrite ( final Variant value )
    {
        ...
        if ( i != null )
        {
            this.device.writeDoubleInteger ( this.block, toGlobalAddress ( this.index ), i.intValue () );
