...
public interface BackEndFactory
{
     ...
     * @param dataItemId id of the data source for which the backends should be retrieved
     ...
     * @throws Exception in case of any problems
     */
    public abstract BackEnd[] getExistingBackEnds ( final String dataItemId, final long detailLevelId, final CalculationMethod calculationMethod ) throws Exception;
