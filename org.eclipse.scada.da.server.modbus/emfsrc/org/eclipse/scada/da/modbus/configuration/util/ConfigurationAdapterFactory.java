...
public class ConfigurationAdapterFactory extends AdapterFactoryImpl
{
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.DevicesType <em>Devices Type</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.DeviceType <em>Device Type</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore
     * cases;
     * it's useful to ignore a case when inheritance will catch all the cases
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.DocumentRoot <em>Document Root</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore
     * cases;
     * it's useful to ignore a case when inheritance will catch all the cases
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.ItemType <em>Item Type</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore
     * cases;
     * it's useful to ignore a case when inheritance will catch all the cases
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.ModbusSlave <em>Modbus Slave</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore
     * cases;
     * it's useful to ignore a case when inheritance will catch all the cases
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.scada.da.modbus.configuration.RootType <em>Root Type</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore
     * cases;
     * it's useful to ignore a case when inheritance will catch all the cases
