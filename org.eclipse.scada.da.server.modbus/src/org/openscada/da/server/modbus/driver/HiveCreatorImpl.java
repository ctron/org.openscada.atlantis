...
public class HiveCreatorImpl implements HiveCreator
{
    ...
    {
        if ( !reference.equals ( org.openscada.da.server.modbus.driver.Hive.class.getName () ) )
        {
            return null;
        }
        ...
        {
            return new org.openscada.da.server.modbus.driver.Hive ( (RootType)configuration );
        }
        else if ( configuration instanceof String )
        {
            return new org.openscada.da.server.modbus.driver.Hive ( (String)configuration );
        }
        else
        {
            return null;
