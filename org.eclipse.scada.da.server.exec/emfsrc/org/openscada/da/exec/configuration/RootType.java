 ...
 * <ul>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getQueue <em>Queue</em>}</li>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getCommand <em>Command</em>}</li>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getHiveProcess <em>Hive Process</em>}</li>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link org.openscada.da.exec.configuration.RootType#getAdditionalConfigurationDirectory <em>Additional Configuration Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType()
...
public interface RootType extends EObject
{
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_Group()
     ...
     * The list contents are of type {@link org.openscada.da.exec.configuration.QueueType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_Queue()
     ...
     * The list contents are of type {@link org.openscada.da.exec.configuration.SplitContinuousCommandType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_Command()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link org.openscada.da.exec.configuration.HiveProcessCommandType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_HiveProcess()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link org.openscada.da.exec.configuration.TriggerCommandType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_Trigger()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see org.openscada.da.exec.configuration.ConfigurationPackage#getRootType_AdditionalConfigurationDirectory()
