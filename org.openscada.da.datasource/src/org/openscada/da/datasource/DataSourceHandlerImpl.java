...
public class DataSourceHandlerImpl implements DataSourceListener, DataSourceHandler
{
    ...
    /* (non-Javadoc)
     * @see org.openscada.da.datasource.DataSourceHandler#dispose()
     */
    @Override
    public void dispose ()
    {
    ...
    /* (non-Javadoc)
     * @see org.openscada.da.datasource.DataSourceHandler#getValue()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.openscada.da.datasource.DataSourceHandler#getType()
     */
    @Override
