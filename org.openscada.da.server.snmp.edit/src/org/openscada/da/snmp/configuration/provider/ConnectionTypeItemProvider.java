    ...
    protected void addAddressPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_ConnectionType_address_feature", "_UI_ConnectionType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addCommunityPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_ConnectionType_community_feature", "_UI_ConnectionType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addNamePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_ConnectionType_name_feature", "_UI_ConnectionType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addVersionPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_ConnectionType_version_feature", "_UI_ConnectionType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
