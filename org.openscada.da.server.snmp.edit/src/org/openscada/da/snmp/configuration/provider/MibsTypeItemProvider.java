        ...
        IItemPropertySource
{
    ...
    protected void addStaticMibNamePropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_MibsType_staticMibName_feature", "_UI_MibsType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addMibDirPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_MibsType_mibDir_feature", "_UI_MibsType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ConfigurationPackage.Literals.MIBS_TYPE__MIB_DIR,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addRecursiveMibDirPropertyDescriptor ( Object object )
    {
        itemPropertyDescriptors.add
                ...
                ( ( (ComposeableAdapterFactory)adapterFactory ).getRootAdapterFactory (),
                        ...
                        getString ( "_UI_PropertyDescriptor_description", "_UI_MibsType_recursiveMibDir_feature", "_UI_MibsType_type" ), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures ( Object object )
    {
        if ( childrenFeatures == null )
        {
            ...
            childrenFeatures.add ( ConfigurationPackage.Literals.MIBS_TYPE__GROUP );
        }
    ...
    {
        return overlayImage ( object, getResourceLocator ().getImage ( "full/obj16/MibsType" ) ); //$NON-NLS-1$
    }
    ...
    protected void collectNewChildDescriptors ( Collection<Object> newChildDescriptors, Object object )
    {
        ...
        newChildDescriptors.add
                ...
                ( ConfigurationPackage.Literals.MIBS_TYPE__GROUP,
                        FeatureMapUtil.createEntry
                                ( ConfigurationPackage.Literals.MIBS_TYPE__STATIC_MIB_NAME, "" ) ) ); //$NON-NLS-1$
        ...
        newChildDescriptors.add
                ...
                ( ConfigurationPackage.Literals.MIBS_TYPE__GROUP,
                        FeatureMapUtil.createEntry
                                ( ConfigurationPackage.Literals.MIBS_TYPE__RECURSIVE_MIB_DIR, "" ) ) ); //$NON-NLS-1$
    }
