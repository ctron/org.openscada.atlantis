...
public class LevelMonitorLow extends AbstractNumericMonitor
{

    public LevelMonitorLow ( final BundleContext context, final EventProcessor eventProcessor, final String id, final String masterId, final Map<String, String> properties )
    {
