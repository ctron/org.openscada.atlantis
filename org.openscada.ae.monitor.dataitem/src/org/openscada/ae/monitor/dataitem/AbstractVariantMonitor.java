...
public abstract class AbstractVariantMonitor extends AbstractDataItemMonitor
{
    ...
    public AbstractVariantMonitor ( final BundleContext context, final Executor executor, final ObjectPoolTracker<MasterItem> poolTracker, final EventProcessor eventProcessor, final String id, final String prefix, final String defaultMonitorType )
    {
