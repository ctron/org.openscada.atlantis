...
package org.openscada.ca.server.exporter.ngp;

import org.openscada.ca.server.Service;
import org.openscada.ca.server.ngp.Exporter;
...
public class Activator implements BundleActivator
{
    ...
    protected void handleServiceChange ( final Service service )
    {
        ...
        try
        {
            ...
            if ( service != null )
            {
                this.exporter = new Exporter ( service, ConnectionInformation.fromURI ( System.getProperty ( "openscada.ca.ngp.exportUri", "hd:ngp://0.0.0.0:2401" ) ) );
                this.exporter.start ();
            }
        }
